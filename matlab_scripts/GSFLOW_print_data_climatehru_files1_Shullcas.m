...
in_climatedata_dir =  '/media/gcng/STORAGE3A/GSFLOW/Shullcas_Updated_gcng/Data/climate/';
...
%   - ymdhms_v
in_datafil = strcat(in_climatedata_dir, 'Huaytapallana_MetData_F.txt');
