% PRMS_print_paramfile3.m
% (11/25/15)
% v3 - updated 9/4/16 by gcng

% Creates inputs files to run PRMS, based on the "Merced" example but
% leaves out many of the "extra" options. v3 sets up problem for "Toro"
...
parfil = '/home/awickert/Dropbox/AGU2015/PRMSinput/base/Toro.param';
...
title_str1 = 'TEST';
title_str2 = 'much based on merced example, using climate_hru';
